...
module.exports = {
	gtins: {
		'00300028799598::CognizantVRS': { endpoint : 'https://lp02-team-m-responder-server.herokuapp.com', requestType: constants.CI_TYPE_REST_ENDPOINT, entityType:constants.ENTITY_TYPE_MANUFACTURER , entityId:'Pfizer'},
		'00301696438109::CognizantVRS': { endpoint : 'https://lp02-team-m-responder-server.herokuapp.com', requestType: constants.CI_TYPE_REST_ENDPOINT, entityType:constants.ENTITY_TYPE_MANUFACTURER , entityId:'Pfizer'},
